    ...
    public class NPCDataProvider
    {
        public Dictionary<string, NPCInfo> GetNPCData()
        {
            return new Dictionary<string, NPCInfo>
            {
                ...
                { "Leo", new NPCInfo("Leo", "summer 26", new List<string> { "444", "289", "834", "906", "ParrotEgg" }) },

                // Fall
                { "Penny", new NPCInfo("Penny", "fall 2", new List<string> { "60", "376", "651", "72", "164", "218", "230", "244", "254", "book_item" }) },
                ...
                { "Sebastian", new NPCInfo("Sebastian", "winter 10", new List<string> { "84", "227", "236", "575", "305", "FrogEgg" }) },
